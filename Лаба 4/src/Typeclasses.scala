...
object Typeclasses {
  ...
  def main(args: Array[String]): Unit = {
    println("Reverse")
    println("String:" + testReversableString("String"))
    println("Smash")
    println("Int (5+10): " + testSmashInt(5, 10))
    println("Double (1.2*2.0): " + testSmashDouble(1.2, 2.0))
    println("String (\"Str\"+\"ing\"): " + testSmashString("Str","ing"))
  }
}